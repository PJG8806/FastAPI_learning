...
from Day4.fastapi_assignment.app.models.movies import Movie
from Day4.fastapi_assignment.app.schemas.movies import MovieResponse, CreateMovieRequest, MovieSearchParams, MovieUpdateRequest
